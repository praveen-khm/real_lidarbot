# I2C communication between an MPU6050 accel/gyro module and a Raspberry Pi is handled 
# in this program.

# Adapted from Martijn (https://github.com/m-rtijn/mpu6050)
...
class mpu6050:
    ...
    def get_gyro_data(self, rads = True):
        """Gets and returns the X, Y and Z values from the gyroscope.
        Returns the read values in a dictionary.

        If rads is True, gyro data is returned in rad/sec. Otherwise data
        is returned in deg/sec.
        """
